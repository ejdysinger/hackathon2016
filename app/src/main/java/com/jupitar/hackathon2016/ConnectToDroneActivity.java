package com.jupitar.hackathon2016;
...
public class ConnectToDroneActivity extends DemoBaseActivity implements OnClickListener {
    private static final String TAG = "ConnectToDroneActivity";
        ...
        public boolean handleMessage(Message msg) {
            switch (msg.what) {
                case SHOWDIALOG:
                    break;
                case SHOWTOAST:
                    Toast.makeText(ConnectToDroneActivity.this, (String)msg.obj, Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
